...
<tiles:useAttribute name="contextOnglet" scope="request" />
...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/menuOnglets.css">
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/contenuPage.css">
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/displaytag.css">
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/css/pageAvecOnglet.css">
...
<div id="menuOnglets"><tiles:insertAttribute name="menuOnglets"></tiles:insertAttribute></div>
<div id=contenuPage>
