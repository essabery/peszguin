...
public class Consultation extends ActionSupport implements SessionAware {
	...
	public String initialiser() {
		init = true;
		participants = daoFactory.getParticipantDAO().findAll();
		return SUCCESS;
	}

	@SuppressWarnings("unchecked")
	public String afficher() {
		participant = daoFactory.getParticipantDAO().findById(idParticipant);
		session.put("idParticipant", idParticipant);
		List<Tournoi> allTournois = daoFactory.getTournoiDAO().findByStatut(
